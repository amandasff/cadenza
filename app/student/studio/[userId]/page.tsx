...
const POLLS = [
  {
    ...
    options: [
      ...
      { id: "wikipedia", label: "Have a Wikipedia page someday" },
      { id: "cry",       label: "Make the whole crowd cry" },
      { id: "famous",    label: "Be famous by 25" },
    ],
  },
  {
    id: "walkon",
    ...
    options: [
      { id: "brightside", label: "Mr. Brightside" },
      { id: "bohemian",   label: "Bohemian Rhapsody" },
      { id: "clair",      label: "Clair de Lune" },
      { id: "allido",     label: "All I Do Is Win" },
    ],
  },
  {
    id: "season",
    ...
    options: [
      { id: "spring",  label: "Spring — fresh and full of surprises" },
      { id: "summer",  label: "Summer — loud, electric, alive" },
      { id: "fall",    label: "Autumn — deep, layered, complex" },
  ...
  },
  {
    ...
    options: [
      { id: "biopic",    label: "Epic biopic (think Bohemian Rhapsody)" },
      { id: "underdog",  label: "Classic underdog story" },
      { id: "indie",     label: "Quirky indie film with a great soundtrack" },
  ...
  },
  {
    ...
    options: [
      { id: "zimmer",    label: "A Hans Zimmer epic" },
      { id: "lofi",      label: "A Spotify lo-fi playlist" },
      { id: "broadway",  label: "A full Broadway score" },
      { id: "williams",  label: "A John Williams adventure" },
    ],
  },
  {
    id: "era",
    question: "Their musical era is:",
    options: [
      { id: "ahead",    label: "Renaissance — ahead of their time" },
      { id: "golden",   label: "Golden Age — peak form" },
      { id: "indie",    label: "Indie phase — finding their sound" },
      { id: "comeback", label: "The comeback arc" },
    ],
  },
  {
    id: "vibe",
    ...
    options: [
      ...
      { id: "oldsoul", label: "Old soul in a young body" },
      { id: "chaos",   label: "Controlled chaos" },
    ],
  },
];
