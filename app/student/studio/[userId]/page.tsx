...
const POLLS = [
  {
    id: "practice_type",
    question: "Their practice personality is…",
    options: [
      { id: "onemorerun",  label: "\"Just one more run\" (3hrs later)" },
      { id: "speedrun",    label: "\"Sounds good enough\" speedrunner" },
      { id: "experimenter",label: "\"What if I changed this part\" person" },
      { id: "rabbit",      label: "YouTube rabbit hole researcher" },
    ],
  },
  {
    id: "metronome",
    question: "Their relationship with the metronome:",
    options: [
      { id: "always",   label: "Always on. We respect this." },
      { id: "freestyle",label: "Starts with it, then \"freestyles\"" },
      { id: "timer",    label: "Uses it as a break timer" },
      { id: "fears",    label: "The metronome fears THEM" },
    ],
  },
  {
    id: "sheet_music",
    question: "Their sheet music looks like:",
    options: [
      { id: "perfect",    label: "Color-coded, laminated, pristine" },
      { id: "annotated",  label: "More pencil marks than actual notes" },
      { id: "questions",  label: "One highlighter, many question marks" },
      { id: "memorized",  label: "\"I memorized it\" (they didn't)" },
    ],
  },
  {
    id: "most_likely",
    ...
    options: [
      { id: "carnegie",   label: "Perform at Carnegie Hall" },
      { id: "3am",        label: "Still be practicing at 3am" },
      { id: "notready",   label: "Turn down a gig — \"not ready yet\"" },
      { id: "newpieces",  label: "Start 4 pieces before finishing one" },
    ],
  },
  {
    id: "band_role",
    question: "In a band they'd be:",
    options: [
      { id: "frontman",  label: "The frontman stealing every spotlight" },
      { id: "bassist",   label: "The bassist who secretly runs everything" },
      { id: "drummer",   label: "The drummer who's actually the best" },
      { id: "soundcheck",label: "\"One more soundcheck\" person" },
    ],
  },
  {
    id: "origin",
    question: "Their musician origin story:",
    options: [
      { id: "forced",    label: "Forced into lessons, secretly loved it" },
      { id: "airguitarr",label: "Air guitar phase that never ended" },
      { id: "onesong",   label: "One song changed everything" },
      { id: "born",      label: "Born with a metronome soul" },
    ],
  },
  {
    id: "villain",
    question: "As a movie villain, they'd be:",
    options: [
      { id: "organ",     label: "Plays ominous pipe organ in a castle" },
      { id: "mastermind",label: "Mastermind who's always 10 steps ahead" },
      { id: "monologue", label: "The one who monologues way too long" },
      { id: "point",     label: "The one who actually had a point" },
    ],
  },
];
