        ...
        <div style={{ background: "var(--white)", border: "1px solid var(--border)", borderRadius: 4 }}>
          ...
          <div style={{ padding: "1.25rem 1.75rem 0" }}>
            <div style={{ display: "flex", border: "1px solid var(--border)", borderRadius: 3, overflow: "hidden" }}>
              {(["student", "teacher", "parent"] as UserRole[]).map(r => (
                ...
                >
                  {r === "student" ? t.auth.labelStudent : r === "teacher" ? t.auth.labelTeacher : t.auth.labelParent}
                </button>
              ))}
            </div>
          </div>
          ...
          <div style={{ borderTop: "1px solid var(--border)", padding: "1.25rem 1.75rem" }}>
            ...
            >
              ...
              {t.auth.continueWithGoogleAs.replace("{role}", role === "teacher" ? t.auth.labelTeacher : role === "parent" ? t.auth.labelParent : t.auth.labelStudent)}
            </button>
          </div>
