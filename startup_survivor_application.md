...
Music students consistently under-practice — leaving teachers frustrated and progress stalled. Cadenza is an AI-native platform where teachers assign structured practice, students receive real-time AI coaching between lessons, and gamification makes practice genuinely engaging. Teachers distribute it to families, who pay for better outcomes at home. Already live with 9 students, showing 2x improvement in lesson outcomes. AI makes this kind of between-lesson support possible for the first time.
...
Cadenza is a B2B2C platform that makes the time between lessons as valuable as the lesson itself.
...
- Gamified practice streaks, points, and goals that build consistent habits
- A direct line to their teacher for questions and encouragement
...
The benefit is not features — it is that students actually practice, arrive prepared, and improve. Teachers run better lessons. Parents see results. Students stay enrolled.
...
- **Students**: responded strongly to gamification — streaks, points, and challenges created genuine motivation where parental nagging had failed

Confidence in findings: I am an active music teacher with 9 students currently on the platform. I see the before/after in real time. These are not theoretical interviews — they are ongoing relationships, which means I can validate insights over months, not just once.
...
- **Competitor analysis**:
  - *Tonara*: closest competitor, raised $5M USD, had thousands of customers — and recently shut down. This confirms the problem is real and that market appetite exists, but that execution and business model matter enormously.
  - *My Practice Space*: not AI-native, not gamified, small market penetration, targets teacher-side management rather than parent/student engagement
  - *MyMusicStaff / TutorBird*: studio management tools only; do not address the practice problem at all
- **SWOT**: Strength = deep domain expertise + AI-native architecture; Weakness = solo founder pre-revenue; Opportunity = AI capabilities enabling features previously impossible; Threat = large edtech players entering music verticals
- **Insight**: No current product is AI-native, gamified, and targeted at the parent-pays-for-student-outcomes model simultaneously. The gap is wide open.
...
**B2B2C** — teachers are the distribution channel, parents are the paying customers.
...
- **Tonara** (closed): proved demand exists and that $5M of VC believed in the space — but their model was teacher-facing subscription, not parent-facing outcomes
- **My Practice Space**: not AI-native, minimal gamification, low market penetration, positioned for teacher studio management rather than student engagement
- **MyMusicStaff / TutorBird**: pure studio management, completely ignore the practice problem — I can replicate their utility with AI in a fraction of the time and offer it free to teachers
...
3. **Network effects**: students build social profiles, practice histories, and streaks on the platform — switching costs grow over time
4. **Teacher advocacy**: teachers who earn revenue share become our sales team; competitors cannot easily replicate this loyalty
5. **Domain expertise**: built by an active music teacher who lives the problem — product decisions are grounded in real teaching experience, not assumptions

**17. Intellectual Property**

- The Cadenza software platform and its architecture are proprietary, fully developed by the founder
- AI models trained to analyze and provide feedback on music practice recordings are local and proprietary
- Growing network effects: student progress histories, social profiles, teacher-student relationships, and practice libraries create compounding switching costs
- Churn is naturally low — the product is embedded in ongoing in-person lesson relationships, which students rarely leave abruptly
- Plan to pursue social/community features (peer performance sharing, famous musician presence) that create additional lock-in and virality

---

## Founder & Team

**18. Solo Founder or Team?**
Solo Founder
...
- Hands-on experience with 9 students on the live Cadenza platform with measurable outcomes
...
- **Marketing / growth**: planning to develop teacher referral flywheel; will seek advisor with B2B2C distribution experience
...
I want to use this summer to turn a working product with proven results into a real business with paying customers. Specifically:
...
2. **Business model validation**: confirm that the teacher-distribution, parent-pays model works at small scale before seeking investment
3. **Mentorship on B2B2C**: I have built the product — I need structured guidance on how to acquire teachers efficiently and convert their networks into paying subscribers
4. **Accountability and structure**: the program's weekly check-ins and deliverable structure will force the discipline that early-stage founders need to avoid spinning on product instead of growth
5. **Network**: access to founders, investors, and advisors who can accelerate fundraising conversations once initial traction is demonstrated

Cadenza already works. I have used it on 9 students and seen 2x improvement in lesson outcomes. This summer is the right moment to scale it up.
...
- [ ] I live in/can commute to Hamilton for all in-person events
- [ ] At least one co-founder can attend all events Mon–Fri 9AM–5PM
- [ ] I will prioritize Startup Survivor and spend min. 20hrs/week May 4–Aug 28, 2026

---

**25. Customer Discovery Excel File**
*Upload via online form portal.*
